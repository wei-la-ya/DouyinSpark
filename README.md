...
1. 部署独立服务 [douyin-spark-login](https://github.com/wei-la-ya/douyin-spark-login)（clone 后 `uv run start` 即可运行）
2. Web 控制台 → DouyinSpark 配置 → 开启「使用外置配置服务」，「配置服务地址」填外置服务地址
